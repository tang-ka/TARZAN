...
UCubeComponent::UCubeComponent() {
	...
	vertices = {
		{1.f, 1.f, -1.f,	1.f, 1.f, 1.f, 1.f,		0.5f,1.f	},   // Vertex 0.
		{-1.f, 1.f, -1.f,	1.f, 1.f, 1.f, 1.f,		0.f,1.f		},  // Vertex 1.
		{-1.f, 1.f, 1.f,	1.f, 1.f, 1.f, 1.f,		0.f,0.5f	},    // And so on.
		{1.f, 1.f, 1.f,		1.f, 1.f, 1.f, 1.f,		0.5f,0.5f	},
		{1.f, -1.f, -1.f,	1.f, 1.f, 1.f, 1.f,		0.5f,0.f	},
		{-1.f, -1.f, -1.f,	1.f, 1.f, 1.f, 1.f,		0.f,0.f		},
		{-1.f, -1.f, 1.f,	1.f, 1.f, 1.f, 1.f,		0.f,0.5f	},
		{1.f, -1.f, 1.f,	1.f, 1.f, 1.f, 1.f,		0.5f,0.5f	},
	};
